...
Tuple1 = { 'A' : [ 'B' ,'C', 'D']}
ReturnedTuple1 = DatabaseInterface.ProcessFoundTuples(Tuple1)
...
Tuple2 = { 'A' : [ 'B' ,'$$_C-1', 'D']}
ReturnedTuple2 = DatabaseInterface.ProcessFoundTuples(Tuple2)
...
ReturnedTuple3 = DatabaseInterface.ProcessFoundTuples(Tuple3)
...
ReturnedTuple4 = DatabaseInterface.ProcessFoundTuples(Tuple4)
